    ...
    return (
      <footer className="bg-gray-900 text-white py-6 px-4 text-center mt-10">
        ...
        <div className="mt-2 space-x-4">
          <a href="https://twitter.com/seanmizzy" className="hover:underline text-blue-400">Twitter</a>
          <a href="https://github.com/seanmizzy" className="hover:underline text-blue-400">GitHub</a>
